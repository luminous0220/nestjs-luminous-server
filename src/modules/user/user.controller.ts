import { Controller, Body, Get, Query, Put, Post, Param, Req } from '@nestjs/common'
...
export class UserController {
  ...
  @Roles([ROLE_ENUME.ADMIN])
  @ApiBearerAuth()
  async assign(@Req() req: Request, @Param('id') id: number, @Body() body: AssignRoleDto) {
    await this.userService.assign(req, id, body)
  }
}
